    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.setOnItemClickListener(new OnProductItemClickListener() {
            ...
            public void onItemClick(MainAdapter.ViewHolder holder, View view, int position) {
                ...
                intent2.putExtra("id", adapter.getItem(position).getId());
                        ...
                        new MyButtonClickListener() {
                            ...
                            public void onClick(int pos) {
                                try {
                                    ...
                                    Toast.makeText(SelectedCategoryActivity.this, "삭제 중 오류가 발생했습니다.", Toast.LENGTH_SHORT).show();
                                    Log.e("SelectedCategoryActivity", "Error deleting item", e);
                                }
                            }
                        }));
            }
    ...
    protected void initItemList() {
        ...
        if (cursor != null) {
            while (cursor.moveToNext()) {
                ...
                items.add(new Product(id, productName, category, company, lifeYear, lifeMonth, lifeDay, image, barcategory, usedate, expirationDate));
