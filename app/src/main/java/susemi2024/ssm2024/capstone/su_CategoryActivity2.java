...
public class su_CategoryActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new su_CategoryAdapter2(this);
        ...
        adapter.setOnItemClickListener(new OnCategoryItemClickListener2() {
            @Override
